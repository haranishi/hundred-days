...
import { DURATION_SECONDS, RESULT_START, STORYBOARD, TAPS, T_HINT_TAP } from './timeline.mjs';
...
const SECTION = {
  ...
  hint: onBeat(T_HINT_TAP),             // ここでローパスがわずかに開く
  wiki: onBeat(sceneStart('S4')),       // 副旋律を足して持ち上げる
  result: onBeat(sceneStart('S5')),
  promise: onBeat(sceneStart('S6')),    // ドラムを抜く
  end: onBeat(sceneStart('S7'))         // 終止和音
};
