 ...
 *
 *   PLAYWRIGHT=/path/to/playwright/index.js node day-011-photo-metadata/tools/make-sample.mjs
 *
...
try {
  ...
  console.error('例: PLAYWRIGHT=/path/to/playwright/index.js node day-011-photo-metadata/tools/make-sample.mjs');
  process.exit(1);
}
