...
import { DEFAULT_FPS, DURATION_SECONDS, FIXED_TIME, previewTimes } from './timeline.mjs';
...
const work = mkdtempSync(join(tmpdir(), 'day028-promo-'));
let server;
let browser;
try {
  ...
  // 木の姿は「今日の日付」で決まる。親ページと iframe の両方の時計を止めてから開く。
