...
const SECTION = {
  answer: onBeat(sceneStart('S1')),   // 答えが出る
  coins: onBeat(sceneStart('S2')),    // 柱を下る
  near: onBeat(sceneStart('S3')),     // 層を開く
  chart: onBeat(sceneStart('S4')),    // 場所を変える（いちばんの山）
  confirm: onBeat(T_CONFIRM_TAP),
  facts: onBeat(sceneStart('S5')),    // 柱の底
  caveat: onBeat(sceneStart('S6')),   // 出典
