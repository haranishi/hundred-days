/* 本物の配信データと同じ形の小さな標本。上流は10分ごとに中身が変わるので、
   固定できるのはこちらだけ。地点番号の上2桁は府県ブロック（86=熊本、50=静岡、32=秋田、12=北海道、52=岐阜、91=沖縄）。
   那覇は本土から遠いので、全体表示では別枠に出る地点として使う。 */
...
export const TABLE = {
  ...
  91197: { type: 'A', elems: '11111111', lat: [26, 12.4], lon: [127, 41.3], alt: 28, kjName: '那覇', knName: 'ナハ', enName: 'Naha' },
};
